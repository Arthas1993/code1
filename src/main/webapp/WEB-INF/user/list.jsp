...
<div style="margin-top:15px;">
	...
	<div style="float:right"><a href="${pageContext.request.contextPath}/user/list.do?page=1&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">第一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user/list.do?page=${(PAGE-1)<=0?1:(PAGE-1)}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user/list.do?page=${PAGE+1>PAGECONT?PAGECONT:PAGE+1}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user/list.do?page=${PAGECONT}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">最后页</a>&nbsp;&nbsp;&nbsp;&nbsp;当前第${PAGE}页 /共${PAGECONT}页</div>
</div>
</body>
</html>